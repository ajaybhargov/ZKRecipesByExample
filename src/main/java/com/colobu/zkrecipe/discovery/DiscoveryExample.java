...
public class DiscoveryExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            serviceDiscovery =
                ServiceDiscoveryBuilder.builder(InstanceDetails.class).client(client).basePath(PATH).serializer(serializer).build();
    ...
    private static void listRandomInstance(String[] args, ServiceDiscovery<InstanceDetails> serviceDiscovery,
        ...
        if (provider == null) {
            provider =
                serviceDiscovery.serviceProviderBuilder().serviceName(serviceName).providerStrategy(new RandomStrategy<InstanceDetails>())
                    .build();
